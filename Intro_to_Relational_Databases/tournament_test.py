...
def testDeleteMatches():
    ...
    print "successfully completed testDeleteMatches()\n"

def testDeletePlayers():
    deletePlayers()
    print "2. Players can be deleted."
    print "successfully completed testDeletePlayers()\n"
...
def testCountPlayers():
    ...
    print "successfully completed testCountPlayers()\n"

def testRegisterPlayer():
    deleteMatches()
    deletePlayers()
    registerPlayer("Mike Smith")
    registerPlayer("Leeroy Jenkins")
    c = countPlayers()
    if c != 2:
        raise ValueError("After two player registers, countPlayers() should be 2.")
    print "4. After registering a player, countPlayers() returns 2."
    print "successfully completed testRegisterPlayer()\n"
...
def testCount():
    ...
    print "successfully completed testCount()\n"
...
def testStandingsBeforeMatches():
    ...
    print "successfully completed testStandingsBeforeMatches()\n"
...
def testReportMatches():
    ...
    print "successfully completed testReportMatches()\n"
